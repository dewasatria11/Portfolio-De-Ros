    ...
    >
      ...
      <div className="flex justify-end gap-2 pt-1">
        ...
        <button type="submit" disabled={uploading} className="relative group/s">
          ...
          <div className="relative flex items-center gap-2 px-5 py-2 bg-background rounded-xl border border-white/10">
            {uploading ? (
    ...
    <div className="space-y-6z ">
      ...
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        ...
        >
          ...
          <div className="relative flex items-center gap-2 px-4 py-2.5 bg-background rounded-xl border border-white/10">
